...
--
insert into dbo.SurroundingSkin(SurroundingSkinName) values ('Oedema');
insert into dbo.SurroundingSkin(SurroundingSkinName) values ('Discolored');
insert into dbo.SurroundingSkin(SurroundingSkinName) values ('Blistered');
insert into dbo.SurroundingSkin(SurroundingSkinName) values ('Inflammation');
insert into dbo.SurroundingSkin(SurroundingSkinName) values ('Heat');
