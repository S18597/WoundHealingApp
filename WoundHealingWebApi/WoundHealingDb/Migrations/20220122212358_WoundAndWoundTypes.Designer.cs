...
namespace WoundHealingDb.Migrations
{
    ...
    [Migration("20220122212358_WoundAndWoundTypes")]
    partial class WoundAndWoundTypes
    {
            ...
            modelBuilder.Entity("WoundHealingDb.Models.Wound", b =>
                {
                    b.HasOne("WoundHealingDb.Models.PainLevel", "PainLevel")
                        .WithOne()
                        .HasForeignKey("WoundHealingDb.Models.Wound", "PainLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WoundHealingDb.Models.PainType", "PainType")
                        .WithOne()
                        .HasForeignKey("WoundHealingDb.Models.Wound", "PainTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WoundHealingDb.Models.SurroundingSkin", "SurroundingSkin")
                        .WithOne()
                        .HasForeignKey("WoundHealingDb.Models.Wound", "SurroundingSkinId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("WoundHealingDb.Models.WoundBleeding", "WoundBleeding")
                        .WithOne()
                        .HasForeignKey("WoundHealingDb.Models.Wound", "WoundBleedingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WoundHealingDb.Models.WoundColor", "WoundColor")
                        .WithOne()
                        .HasForeignKey("WoundHealingDb.Models.Wound", "WoundColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WoundHealingDb.Models.WoundExudate", "WoundExudate")
                        .WithOne()
                        .HasForeignKey("WoundHealingDb.Models.Wound", "WoundExudateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WoundHealingDb.Models.WoundLocation", "WoundLocation")
                        .WithOne()
                        .HasForeignKey("WoundHealingDb.Models.Wound", "WoundLocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WoundHealingDb.Models.WoundOdor", "WoundOdor")
                        .WithOne()
                        .HasForeignKey("WoundHealingDb.Models.Wound", "WoundOdorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WoundHealingDb.Models.WoundSize", "WoundSize")
                        .WithOne()
                        .HasForeignKey("WoundHealingDb.Models.Wound", "WoundSizeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WoundHealingDb.Models.WoundType", "WoundType")
                        .WithOne()
                        .HasForeignKey("WoundHealingDb.Models.Wound", "WoundTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
